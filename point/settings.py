...
# Allow large file uploads (audio files up to 100MB)
...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": "point.storage.RelaxedManifestStorage",
    },
}
...
# Print unhandled 500 tracebacks to stdout so they show up in Railway deploy logs
# (Django's default config emails admins instead of logging to the console).
LOGGING = {
    'version': 1,
