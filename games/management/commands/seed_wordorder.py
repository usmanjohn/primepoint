...
SENTENCES = [
    ...
    {'title': 'EN-Med-02', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-03', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-04', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-05', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-06', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-07', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-08', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-09', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-10', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-11', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Med-12', 'language': 'en', 'difficulty': 'medium',
    ...
    {'title': 'EN-Hard-01', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-02', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-03', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-04', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-05', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-06', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-07', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-08', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-09', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-10', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-11', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-12', 'language': 'en', 'difficulty': 'hard',
    ...
    {'title': 'EN-Hard-13', 'language': 'en', 'difficulty': 'hard',
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for data in SENTENCES:
            obj, created = WordOrderChallenge.objects.get_or_create(
                title=data['title'],
                defaults={
            ...
            if created:
                ...
                # Patch language/difficulty on existing rows
                changed = False
                if obj.language != data['language']:
                    obj.language = data['language']
                    changed = True
                if obj.difficulty != data['difficulty']:
                    obj.difficulty = data['difficulty']
                    changed = True
                if changed:
                    obj.save(update_fields=['language', 'difficulty'])
                    updated_count += 1

        self.stdout.write(self.style.SUCCESS(
            f'Done — {created_count} created, {updated_count} updated, '
            f'{len(SENTENCES) - created_count - updated_count} already current.'
        ))
