...
<p>이 폭발을 통해 별 속에 <span class="cn-word" data-pos="verb" data-tr="qamalgan, tiqilib qolgan">갇혀</span> 있던 원소들이 우주 공간으로 <span class="cn-word" data-pos="verb" data-tr="sochilib ketdi">흩어졌고</span>, 오랜 <span class="cn-word" data-tr="vaqt, yillar">세월</span>에 걸쳐 이들이 <span class="cn-word" data-pos="verb" data-tr="jipslashib, birlashib">뭉쳐</span> 지구와 생명체를 만들었다. 그러니 밤하늘의 별을 올려다볼 때, 우리는 <span class="cn-word" data-pos="adv" data-tr="aslida, amalda">사실상</span> <span class="cn-word" data-tr="qarindosh">친척</span>을 바라보고 있는 셈이다. 우리 모두는 <span class="cn-word" data-pos="verb" data-tr="yaltiraydigan">반짝이는</span> 별의 먼지에서 <span class="cn-word" data-pos="verb" data-tr="tugʻilgan">태어난</span> 존재인 것이다.</p>''',
        "grammar": [
            {
                "pattern":  "-을/를 통해(서)",
...
<p>그 정도는 100년에 약 1.7 밀리초로, 하루아침에 <span class="cn-word" data-pos="verb" data-tr="sezilarli">느껴질</span> 만한 변화는 아니다. 하지만 <span class="cn-word" data-pos="adj" data-tr="juda uzoq, olis">아득한</span> 옛날에는 <span class="cn-word" data-tr="ahvol, vaziyat">사정</span>이 달랐다. <span class="cn-word" data-tr="dinozavr">공룡</span>이 살던 시절, 지구의 하루는 지금보다 짧은 약 23시간이었다고 한다. 지금 이 순간에도 우리의 하루는 <span class="cn-word" data-pos="adv" data-tr="sassiz, bilinmasdan">소리 없이</span> 늘어나고 있는 것이다.</p>''',
        "grammar": [
            {
                "pattern":  "-(으)ㄹ 만하다",
...
<p>이 방에서는 밖에서 들리던 <span class="cn-word" data-tr="shovqin">소음</span>이 완전히 사라지기 때문에, 대신 자신의 심장 뛰는 소리와 피가 <span class="cn-word" data-pos="verb" data-tr="oqadigan">흐르는</span> 소리까지 <span class="cn-word" data-pos="adv" data-tr="jonli, aniq-ravshan">생생하게</span> 들린다. <span class="cn-word" data-pos="adv" data-tr="hatto">심지어</span> 어떤 사람은 <span class="cn-word" data-tr="yoʻnalish hissi">방향 감각</span>을 잃고 <span class="cn-word" data-tr="bosh aylanishi">어지러움</span>을 느끼기도 한다. 지금까지 이 방에서 가장 오래 <span class="cn-word" data-pos="verb" data-tr="chidagan, dosh bergan">버틴</span> 기록은 겨우 한 시간 <span class="cn-word" data-pos="adv" data-tr="chamasi, atrofida">남짓</span>이라고 하니, 완벽한 <span class="cn-word" data-tr="sukunat, jimlik">고요</span>가 반드시 <span class="cn-word" data-tr="qulaylik, rohat">편안함</span>을 뜻하는 것은 아닌 셈이다.</p>''',
        "grammar": [
            {
                "pattern":  "-기도 하다",
...
<p>실제로 사하라의 <span class="cn-word" data-tr="gʻor">동굴</span> 벽에서는 <span class="cn-word" data-pos="verb" data-tr="suzayotgan">수영하는</span> 사람들의 그림이 발견되기도 했다. 사막 한가운데에서 수영이라니, <span class="cn-word" data-pos="verb" data-tr="tasavvur qilish">상상</span>하기 어려운 일이다. 학자들은 지구의 <span class="cn-word" data-tr="qiyalik, ogʻish">기울기</span>가 조금씩 <span class="cn-word" data-pos="verb" data-tr="oʻzgargani sari">변하면서</span> 비구름의 <span class="cn-word" data-tr="oqim, harakat">흐름</span>이 바뀌었고, 그 결과 초원이 사막으로 변했다고 설명한다. 그리고 먼 미래에는 사하라가 다시 초록빛을 <span class="cn-word" data-pos="verb" data-tr="qaytarib oladigan">되찾을</span> 것이라고 한다.</p>''',
        "grammar": [
            {
                "pattern":  "-(이)라니",
...
<p>꿀이 이렇게 오래 <span class="cn-word" data-pos="verb" data-tr="saqlanadigan">보존되는</span> <span class="cn-word" data-tr="sir, siri">비결</span>은 무엇일까? 꿀은 <span class="cn-word" data-tr="namlik, suv miqdori">수분</span>이 매우 <span class="cn-word" data-pos="adj" data-tr="kam, oz">적고</span> <span class="cn-word" data-tr="shakar miqdori">당분</span>이 많아서 <span class="cn-word" data-tr="mikrob, bakteriya">세균</span>이 <span class="cn-word" data-pos="verb" data-tr="omon qolishi">살아남기</span> 어려운 <span class="cn-word" data-tr="muhit, sharoit">환경</span>이다. 게다가 <span class="cn-word" data-tr="asalari">꿀벌</span>이 꿀을 만드는 과정에서 세균을 죽이는 물질이 <span class="cn-word" data-pos="adv" data-tr="tabiiy ravishda">자연스럽게</span> 생긴다. 그래서 <span class="cn-word" data-tr="qopqoq">뚜껑</span>만 잘 <span class="cn-word" data-pos="verb" data-tr="yopib">닫아</span> 두면, 꿀은 사실상 <span class="cn-word" data-pos="adv" data-tr="abadiy, mangu">영원히</span> 변하지 않는다.</p>''',
    ...
    # ── 10 ───────────────────────────────────────────────────────────────
    {
        ...
        "order":   10,
        "body": '''<p>지구에서 가장 깊은 곳은 어디일까? 바로 태평양에 있는 ‘<span class="cn-word" data-tr="Marian botigʻi">마리아나 해구</span>’로, 그 깊이가 <span class="cn-word" data-pos="adv" data-tr="naq, hatto">무려</span> 11킬로미터에 <span class="cn-word" data-pos="verb" data-tr="yetadi">이른다</span>. 세계에서 가장 높은 산인 <span class="cn-word" data-tr="Everest togʻi">에베레스트</span>산을 이곳에 <span class="cn-word" data-pos="adv" data-tr="butunlayicha">통째로</span> 넣어도, 산 <span class="cn-word" data-tr="choʻqqi, tepa">꼭대기</span>가 여전히 물속 2킬로미터 아래에 <span class="cn-word" data-pos="verb" data-tr="choʻkib qoladigan, botadigan">잠길</span> 정도이다.</p>
<p>이 깊은 <span class="cn-word" data-tr="dengiz tubi">바닷속</span>은 햇빛 한 줄기 들지 않는 <span class="cn-word" data-tr="qop-qora">칠흑</span> 같은 <span class="cn-word" data-tr="zulmat, qorongʻilik">어둠</span>의 세계다. <span class="cn-word" data-pos="adv" data-tr="bundan tashqari">게다가</span> <span class="cn-word" data-tr="suv bosimi">수압</span>은 <span class="cn-word" data-tr="yer yuzasi">지상</span>의 약 천 배에 <span class="cn-word" data-pos="verb" data-tr="yetadi">달해</span>, 사람이 <span class="cn-word" data-tr="yalangʻoch tan">맨몸</span>으로는 순식간에 <span class="cn-word" data-pos="verb" data-tr="ezilib ketadigan">짓눌릴</span> 만큼 <span class="cn-word" data-pos="adj" data-tr="kuchli, qudratli">강력하다</span>. 놀랍게도 이런 <span class="cn-word" data-tr="oʻta ogʻir, ekstremal">극한</span>의 환경에서도 살아가는 생명체가 있다. 재미있게도, 이 깊은 바다 <span class="cn-word" data-tr="tub, ost">밑바닥</span>에 <span class="cn-word" data-pos="verb" data-tr="borib kelgan">다녀온</span> 사람보다 달에 다녀온 사람이 더 많다고 한다.</p>''',
        "grammar": [
            {
                "pattern":  "-에 이르다 / 달하다",
